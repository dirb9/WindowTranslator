...
public class OneOcrBrtnsCntrstValidator(IContentDialogService dialogService, ILogger<OneOcrBrtnsCntrstValidator> logger) : ITargetSettingsValidator
{
    ...
    private readonly ILogger<OneOcrBrtnsCntrstValidator> logger = logger;
    ...
    public async ValueTask<ValidateResult> Validate(TargetSettings settings)
    {
        ...
        if (settings.SelectedPlugins[nameof(IOcrModule)] != nameof(OneOcrBrtnsCntrst))
        {
